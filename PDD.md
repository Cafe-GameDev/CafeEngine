...
### 2.2. O `CafeSidePanel` (Host de SidePanels)

Todos os **SidePanels** dos plugins são hospedados em um dock lateral unificado chamado **`CafeSidePanel`**, proporcionando uma experiência de usuário coesa para esses painéis.
